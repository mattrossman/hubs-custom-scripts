 ...
 *
 * Try dragging entity-2.glb into the room. You can move it around, scale, it, pin it, whatever!
 * Also works if you add the .glb file to Spoke and add your custom script to a room created with that scene.
 *
 * Import entity-2.glb into the entity generator https://www.aelatgt.org/hubs-entity-generator/
